             ...
             <div class="card-container">
                <div class="card">
                    <div class="front">
                        ...
                        <div class="user">
                            <img class="img-circle" src="img/khoa.jpg" />
                        </div>
                        <div class="content">
                            <div class="main">
                                <h3 class="name">Khoa Nguyen</h3>
                                <p class="profession">CEO</p>
                                <p class="text-center">"I love creating stuff"</p>
                            </div>
                            <div class="footer">
                    ...
                    <div class="back">
                        ...
                        <div class="footer">
                            <div class="social-links text-center">
                                <a href="http://www.imkhoa.com" class="facebook" target="_blank"><i class="fa fa-codepen fa-fw" ></i></a>
                                <a href="https://www.github.com/kdncode" class="google" target="_blank"><i class="fa fa-github fa-fw" ></i></a>
                                <a href="https://www.instagram.com/kdncode" class="twitter" target="_blank"><i class="fa fa-instagram fa-fw" ></i></a>
                            </div>
                        </div>
                    </div> <!-- end back panel -->
                </div> <!-- end card -->
             ...
             <div class="card-container">
                <div class="card">
                    <div class="front">
                        ...
                        <div class="user">
                            <img class="img-circle" src="img/profile_img.png"/>
                        </div>
                        <div class="content">
                            <div class="main">
                                <h3 class="name">Khoa Nguyen</h3>
                                <p class="profession">Web/App Developer</p>
                                <p class="text-center">"Stay positive as always"</p>
                            </div>
                            <div class="footer">
                                <i class="fa fa-mail-forward"></i> Auto Rotation
                            </div>
            ...
            <div class="card-container">
                <div class="card">
                    <div class="front">
                        ...
                        <div class="user">
                            <img class="img-circle" src="img/chrisprofile.png"/>
                        </div>
                        <div class="content">
                            <div class="main">
                                <h3 class="name">Khoa Nguyen</h3>
                    ...
                    <div class="back">
                        <div class="header">
                            <h5 class="motto">"You miss 100% of the shots you don't take - Wayne Gretzky"</h5>
                        </div>
                        <div class="content">
                            <div class="main">
                                <h4 class="text-center">Job Description</h4>
